...
if id_responses.status_code != 200:
    print("Issue - notified in API status code")
else:
    print("Success")
    ...
    for response in responses:
        ...
        if story_responses.status_code != 200:
            print("2ndIssue - notified in API status code")
            continue
